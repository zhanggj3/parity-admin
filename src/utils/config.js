  ...
  contract: {
    ...
    permission_management: {
      abi: [{
        ...
        constant: true, inputs: [], name: 'listPermissions', outputs: [{name: '', type: 'address[]'}], payable: false, stateMutability: 'view', type: 'function',
      }, {
    ...
    role_management: {
      abi: [{
        ...
        constant: true, inputs: [], name: 'listRoles', outputs: [{ name: '', type: 'address[]'}], payable: false, stateMutability: 'view', type: 'function',
      }],
